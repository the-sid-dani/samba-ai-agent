...
from model_server.sambaai_torch_model import ConnectorClassifier
from model_server.sambaai_torch_model import HybridClassifier
...
def warm_up_connector_classifier_model() -> None:
    ...
    input_ids, attention_mask = tokenize_connector_classification_query(
        ["GitHub"],
        "sambaai classifier query google doc",
