...
from sambaai.chat.stream_processing.quotes_processing import match_quotes_to_docs
from sambaai.chat.stream_processing.quotes_processing import separate_answer_quotes
...
def test_passed_in_quotes() -> None:
    ...
    test_answer = """{
        ...
        "quotes": [
            "SambaAI can just ingest PDFs as they are. How GOOD it embeds them depends on the formatting of your PDFs.",
            "the ` sambaai. llm ` package aims to provide a comprehensive framework."
        ]
    }"""
    ...
    test_answer = """{
        ...
        "quotes": [
            "SambaAI can efficiently ingest PDFs, with the quality of embedding depending on the PDF's formatting."
        ]
    }"""
    answer, quotes = separate_answer_quotes(test_answer, is_json_prompt=True)
