...
from sambaai.chat.stream_processing.citation_processing import CitationProcessor
...
"""
This module contains tests for the citation extraction functionality in SambaAI,
...
def process_text(
    ...
    result: list[SambaAIAnswerPiece | CitationInfo] = []
    for token in tokens:
    ...
    citations = []
    for piece in result:
        if isinstance(piece, SambaAIAnswerPiece):
