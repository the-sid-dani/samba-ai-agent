...
from sambaai.connectors.sambaai_jira.connector import _perform_jql_search
from sambaai.connectors.sambaai_jira.connector import process_jira_issue
...
def mock_jira_api_version() -> Generator[Any, Any, Any]:
    with patch("sambaai.connectors.sambaai_jira.connector.JIRA_API_VERSION", "2"):
        yield
...
@patch("sambaai.connectors.sambaai_jira.connector.JIRA_CONNECTOR_MAX_TICKET_SIZE", 50)
