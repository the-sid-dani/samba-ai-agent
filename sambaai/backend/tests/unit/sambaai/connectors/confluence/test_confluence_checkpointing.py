...
from sambaai.connectors.confluence.connector import ConfluenceCheckpoint
...
from tests.unit.sambaai.connectors.utils import load_everything_from_checkpoint_connector
from tests.unit.sambaai.connectors.utils import (
...
def confluence_connector(
    confluence_base_url: str, space_key: str, mock_confluence_client: SambaAIConfluence
    ...
    with patch("sambaai.connectors.confluence.connector._SLIM_DOC_BATCH_SIZE", 2):
        yield connector
...
def test_load_from_checkpoint_with_page_processing_error(
    ...
    with patch(
        "sambaai.connectors.confluence.connector.ConfluenceConnector._convert_page_to_document",
