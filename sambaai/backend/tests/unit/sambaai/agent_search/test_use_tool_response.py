...
from sambaai.agents.agent_search.orchestration.states import ToolCallOutput
from sambaai.agents.agent_search.orchestration.states import ToolChoice
from sambaai.chat.models import DocumentSource
...
from sambaai.tools.tool_implementations.search.search_utils import section_to_llm_doc
...
@patch(
    "sambaai.agents.agent_search.orchestration.nodes.use_tool_response.process_llm_stream"
)
