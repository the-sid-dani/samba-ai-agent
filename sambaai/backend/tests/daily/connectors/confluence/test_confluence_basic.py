...
from sambaai.connectors.confluence.utils import AttachmentProcessingResult
...
def test_confluence_connector_basic(
    ...
    assert page_within_a_page_doc.primary_owners[0].email == "hagen@sambaai.ai"
    ...
    assert (
        ...
        == "https://sambaaiai.atlassian.net/wiki/spaces/DailyConne/pages/200769540/Page+Within+A+Page"
    )
    ...
    assert page_doc.primary_owners[0].email == "hagen@sambaai.ai"
    ...
    assert (
        page_section.link
        == "https://sambaaiai.atlassian.net/wiki/spaces/DailyConne/overview"
    )
...
@patch(
    "sambaai.connectors.confluence.utils._process_image_attachment",
