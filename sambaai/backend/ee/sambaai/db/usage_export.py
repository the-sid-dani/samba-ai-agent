...
from ee.sambaai.db.query_history import fetch_chat_sessions_eagerly_by_time
from ee.sambaai.server.reporting.usage_export_models import ChatMessageSkeleton
from ee.sambaai.server.reporting.usage_export_models import FlowType
...
from sambaai.db.models import UsageReport
...
def get_empty_chat_messages_entries__paginated(
    ...
    for chat_session in chat_sessions:
        flow_type = FlowType.SLACK if chat_session.sambaaibot_flow else FlowType.CHAT
