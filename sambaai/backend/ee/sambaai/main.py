...
from ee.sambaai.configs.app_configs import OIDC_SCOPE_OVERRIDE
from ee.sambaai.configs.app_configs import OPENID_CONFIG_URL
from ee.sambaai.server.analytics.api import router as analytics_router
from ee.sambaai.server.auth_check import check_ee_router_auth
from ee.sambaai.server.documents.cc_pair import router as ee_document_cc_pair_router
from ee.sambaai.server.enterprise_settings.api import (
    admin_router as enterprise_settings_admin_router,
)
from ee.sambaai.server.enterprise_settings.api import (
    basic_router as enterprise_settings_router,
)
from ee.sambaai.server.manage.standard_answer import router as standard_answer_router
from ee.sambaai.server.middleware.tenant_tracking import (
    add_api_server_tenant_id_middleware,
)
from ee.sambaai.server.oauth.api import router as ee_oauth_router
from ee.sambaai.server.query_and_chat.chat_backend import (
    router as chat_router,
)
from ee.sambaai.server.query_and_chat.query_backend import (
    basic_router as query_router,
)
from ee.sambaai.server.query_history.api import router as query_history_router
from ee.sambaai.server.reporting.usage_export_api import router as usage_export_router
from ee.sambaai.server.saml import router as saml_router
from ee.sambaai.server.seeding import seed_db
from ee.sambaai.server.tenants.api import router as tenants_router
from ee.sambaai.server.token_rate_limits.api import (
    router as token_rate_limit_settings_router,
)
from ee.sambaai.server.user_group.api import router as user_group_router
from ee.sambaai.utils.encryption import test_encryption
...
from sambaai.main import get_application as get_application_base
from sambaai.main import include_auth_router_with_prefix
from sambaai.main import include_router_with_global_prefix_prepended
from sambaai.main import lifespan as lifespan_base
from sambaai.main import use_route_function_names_as_operation_ids
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    async with lifespan_base(app):
        # seed the SambaAI environment with LLMs, Assistants, etc. based on an optional
