...
from ee.sambaai.server.oauth.api_router import router
from sambaai.auth.users import current_admin_user
from sambaai.configs.app_configs import DEV_MODE
from sambaai.configs.app_configs import OAUTH_GOOGLE_DRIVE_CLIENT_ID
from sambaai.configs.app_configs import OAUTH_GOOGLE_DRIVE_CLIENT_SECRET
from sambaai.configs.app_configs import WEB_DOMAIN
from sambaai.configs.constants import DocumentSource
from sambaai.connectors.google_utils.google_auth import get_google_oauth_creds
from sambaai.connectors.google_utils.google_auth import sanitize_oauth_credentials
...
class GoogleDriveOAuth:
    ...
    # SCOPE is per https://docs.sambaai.dev/connectors/google-drive
