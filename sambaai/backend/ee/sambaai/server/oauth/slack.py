...
from sambaai.configs.app_configs import OAUTH_SLACK_CLIENT_ID
from sambaai.configs.app_configs import OAUTH_SLACK_CLIENT_SECRET
...
class SlackOAuth:
    ...
    # SCOPE is per https://docs.sambaai.dev/connectors/slack
    BOT_SCOPE = (
        "channels:history,"
        "channels:read,"
        "groups:history,"
