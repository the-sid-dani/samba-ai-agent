...
from ee.sambaai.db.query_history import get_page_of_chat_sessions
from ee.sambaai.db.query_history import get_total_filtered_chat_sessions_count
from ee.sambaai.server.query_history.models import ChatSessionMinimal
from ee.sambaai.server.query_history.models import ChatSessionSnapshot
from ee.sambaai.server.query_history.models import MessageSnapshot
from ee.sambaai.server.query_history.models import QueryHistoryExport
from sambaai.auth.users import current_admin_user
from sambaai.auth.users import get_display_email
...
from sambaai.configs.constants import QAFeedbackType
from sambaai.configs.constants import QueryHistoryType
from sambaai.configs.constants import SessionType
...
from sambaai.db.pg_file_store import get_query_history_export_files
from sambaai.db.tasks import get_task_with_id
...
def snapshot_from_chat_session(
    ...
    flow_type = SessionType.SLACK if chat_session.sambaaibot_flow else SessionType.CHAT
...
def start_query_history_export(
    ...
    task = client_app.send_task(
        SambaAICeleryTask.EXPORT_QUERY_HISTORY_TASK,
