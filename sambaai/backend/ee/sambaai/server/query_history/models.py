...
from ee.sambaai.background.task_name_builders import QUERY_HISTORY_TASK_NAME_PREFIX
from sambaai.auth.users import get_display_email
from sambaai.background.task_utils import extract_task_id_from_query_history_report_name
...
from sambaai.db.models import TaskQueueState
...
class ChatSessionMinimal(BaseModel):
    ...
    def from_chat_session(cls, chat_session: ChatSession) -> "ChatSessionMinimal":
        ...
        return cls(
            ...
            flow_type=(
                SessionType.SLACK if chat_session.sambaaibot_flow else SessionType.CHAT
            ),
