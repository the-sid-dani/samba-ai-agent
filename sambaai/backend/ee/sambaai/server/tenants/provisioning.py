...
from ee.sambaai.configs.app_configs import ANTHROPIC_DEFAULT_API_KEY
from ee.sambaai.configs.app_configs import COHERE_DEFAULT_API_KEY
from ee.sambaai.configs.app_configs import HUBSPOT_TRACKING_URL
from ee.sambaai.configs.app_configs import OPENAI_DEFAULT_API_KEY
from ee.sambaai.server.tenants.access import generate_data_plane_token
from ee.sambaai.server.tenants.models import TenantByDomainResponse
from ee.sambaai.server.tenants.models import TenantCreationPayload
from ee.sambaai.server.tenants.models import TenantDeletionPayload
from ee.sambaai.server.tenants.schema_management import create_schema_if_not_exists
from ee.sambaai.server.tenants.schema_management import drop_schema
from ee.sambaai.server.tenants.schema_management import run_alembic_migrations
from ee.sambaai.server.tenants.user_mapping import add_users_to_tenant
from ee.sambaai.server.tenants.user_mapping import get_tenant_id_for_email
from ee.sambaai.server.tenants.user_mapping import user_owns_a_tenant
from sambaai.auth.users import exceptions
from sambaai.configs.app_configs import CONTROL_PLANE_API_BASE_URL
from sambaai.configs.app_configs import DEV_MODE
from sambaai.configs.constants import MilestoneRecordType
from sambaai.db.engine import get_session_with_shared_schema
from sambaai.db.engine import get_session_with_tenant
from sambaai.db.llm import update_default_provider
from sambaai.db.llm import upsert_cloud_embedding_provider
from sambaai.db.llm import upsert_llm_provider
from sambaai.db.models import AvailableTenant
from sambaai.db.models import IndexModelStatus
from sambaai.db.models import SearchSettings
from sambaai.db.models import UserTenantMapping
from sambaai.llm.llm_provider_options import ANTHROPIC_MODEL_NAMES
from sambaai.llm.llm_provider_options import ANTHROPIC_PROVIDER_NAME
from sambaai.llm.llm_provider_options import ANTHROPIC_VISIBLE_MODEL_NAMES
from sambaai.llm.llm_provider_options import OPEN_AI_MODEL_NAMES
from sambaai.llm.llm_provider_options import OPEN_AI_VISIBLE_MODEL_NAMES
from sambaai.llm.llm_provider_options import OPENAI_PROVIDER_NAME
from sambaai.server.manage.embedding.models import CloudEmbeddingProviderCreationRequest
        ...
        try:
            ...
            if current_search_settings:
                ...
                current_search_settings.index_name = (
                    "sambaai_chunk_cohere_embed_english_v3_0"
                )
...
async def setup_tenant(tenant_id: str) -> None:
    ...
    try:
        ...
        with get_session_with_tenant(tenant_id=tenant_id) as db_session:
            ...
            # Set up SambaAI with appropriate settings
            ...
            setup_sambaai(db_session, tenant_id, cohere_enabled=cohere_enabled)
