...
from ee.sambaai.configs.app_configs import SAML_CONF_DIR
from ee.sambaai.db.saml import expire_saml_account
from ee.sambaai.db.saml import get_saml_account
from ee.sambaai.db.saml import upsert_saml_account
from ee.sambaai.utils.secrets import encrypt_string
from ee.sambaai.utils.secrets import extract_hashed_cookie
...
async def saml_login_callback(
    ...
    # Redirect to main SambaAI search page
