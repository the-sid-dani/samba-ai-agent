...
SAML_CONF_DIR = os.environ.get("SAML_CONF_DIR") or "/app/ee/sambaai/configs/saml_config"
...
# when the capture is called. These defaults prevent Posthog issues from breaking the SambaAI app
