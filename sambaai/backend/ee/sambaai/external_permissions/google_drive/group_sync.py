...
from ee.sambaai.external_permissions.google_drive.folder_retrieval import (
    get_folder_permissions_by_ids,
)
from ee.sambaai.external_permissions.google_drive.folder_retrieval import (
    get_modified_folders,
)
from ee.sambaai.external_permissions.google_drive.models import GoogleDrivePermission
from ee.sambaai.external_permissions.google_drive.models import PermissionType
...
from sambaai.connectors.google_utils.resources import AdminService
...
def _build_sambaai_groups(
    ...
    # Convert all drive member definitions to sambaai groups
    ...
    # Convert all folder permissions to sambaai groups
    ...
    # Convert all group member definitions to sambaai groups
...
def gdrive_group_sync(
    ...
    # Convert the maps to sambaai groups
    sambaai_groups = _build_sambaai_groups(
