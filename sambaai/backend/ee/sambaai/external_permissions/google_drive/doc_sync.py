...
from ee.sambaai.external_permissions.google_drive.permission_retrieval import (
    get_permissions_by_ids,
)
from ee.sambaai.external_permissions.perm_sync_types import FetchAllDocumentsFunction
from sambaai.access.models import DocExternalAccess
from sambaai.access.models import ExternalAccess
...
def _get_permissions_from_slim_doc(
    ...
    for permission in permissions_list:
        ...
        # we will then handle mapping that folder to the list of SambaAI users
