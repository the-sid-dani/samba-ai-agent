...
from ee.sambaai.external_permissions.slack.utils import fetch_user_id_to_email_map
...
from sambaai.connectors.slack.connector import get_channels
from sambaai.connectors.slack.connector import make_paginated_slack_api_call_w_retries
...
def slack_doc_sync(
    ...
    provider = SambaAIDBCredentialsProvider(tenant_id, "slack", cc_pair.credential.id)
