...
from ee.sambaai.configs.app_configs import CONFLUENCE_ANONYMOUS_ACCESS_IS_PUBLIC
...
def _get_server_space_permissions(
    confluence_client: SambaAIConfluence, space_key: str
) -> ExternalAccess:
...
def _extract_read_access_restrictions(
    confluence_client: SambaAIConfluence, restrictions: dict[str, Any]
