...
overview = (
    "How to leverage SambaAI in your organization\n\n"
    "SambaAI Overview\n"
    "SambaAI is the AI Assistant connected to your organization's docs, apps, and people. "
    "SambaAI makes Generative AI more versatile for work by enabling new types of questions like "
    ...
    "SambaAI makes it possible to ask these questions in natural language and get back answers in seconds.\n\n"
    "SambaAI can connect to +30 different tools and the use cases are not limited to the ones in the following pages. "
    ...
    "Why are these docs connected in my SambaAI deployment?\n"
    "Answer: This is just an example of how connectors work in SambaAI. You can connect up your own team's knowledge "
    "and you will be able to ask questions unique to your organization. SambaAI will keep all of the knowledge up to date "
    "and in sync with your connected applications.\n\n"
    "Is my data being sent anywhere when I connect it up to SambaAI?\n"
    "Answer: No! SambaAI is built with data security as our highest priority. We open sourced it so our users can know "
    "exactly what is going on with their data. By default all of the document processing happens within SambaAI. "
    ...
    "Answer: This falls under the Enterprise Edition set of SambaAI features built on top of the MIT/community edition. "
    "If you are on SambaAI Cloud, you have access to them by default. If you're running it yourself, reach out to the "
    "SambaAI team to receive access."
)

enterprise_search_title = "Enterprise Search"
enterprise_search_1 = (
    "Value of Enterprise Search with SambaAI\n\n"
    ...
    "with constant distractions as junior teammates are unable to unblock themselves. SambaAI solves this "
...
enterprise_search_2 = (
    ...
    "in a search bar, your entire team can stay informed and up to date. SambaAI also makes it trivial "
    ...
    "cases for your customer support team to reference, SambaAI breaks down the issue and explains it so that even "
    ...
    "to review 10 hours of transcripts before hopping on that critical call, but SambaAI can easily parse through it "
...
ai_platform = (
    ...
    "SambaAI is helping teams make it happen. SambaAI provides out of the box user chat sessions, attaching custom tools, "
    "handling LLM reasoning, code execution, data analysis, referencing internal knowledge, and much more.\n\n"
    "SambaAI as a platform is not a no-code agent builder. We are made by developers for developers and this gives your "
    "team the full flexibility and power to create agents not constrained by blocks and simple logic paths.\n\n"
    "Flexibility and Extensibility\n"
    "SambaAI is open source and completely whitebox. This not only gives transparency to what happens within the system "
...
customer_support = (
    ...
    "SambaAI takes care of both of these. The system connects up to over 30+ different applications and the knowledge is "
...
sales = (
    ...
    'hours of transcripts in preparation for a call, your team can now ask SambaAI "What specific features was ACME '
    "interested in seeing for the demo\". Since your team doesn't have time to read every transcript prior to a call, "
    "SambaAI provides a more thorough summary because it can instantly parse hundreds of pages and distill out the relevant "
    ...
    "prospect (and as we know, time is the biggest killer of deals). With SambaAI, it is even possible to get answers live "
...
operations = (
    ...
    "details or how to set up the VPN for remote work, SambaAI can help your team help themselves. This frees up your team to "
    ...
    "of new tools, SambaAI gives them a single place where they can ask about anything in natural language. Whether it's how to "
    "set up their work environment or what their onboarding goals are, SambaAI can walk them through every step with the help "
...
overview_doc = SeedPresaveDocument(
    url="https://docs.sambaai.app/more/use_cases/overview",
...
enterprise_search_doc = SeedPresaveDocument(
    url="https://docs.sambaai.app/more/use_cases/enterprise_search",
...
ai_platform_doc = SeedPresaveDocument(
    url="https://docs.sambaai.app/more/use_cases/ai_platform",
...
customer_support_doc = SeedPresaveDocument(
    url="https://docs.sambaai.app/more/use_cases/support",
...
sales_doc = SeedPresaveDocument(
    url="https://docs.sambaai.app/more/use_cases/sales",
    title=sales_title,
    content=sales,
...
operations_doc = SeedPresaveDocument(
    url="https://docs.sambaai.app/more/use_cases/operations",
...
with open("./backend/sambaai/seeding/initial_docs.json", "w") as json_file:
