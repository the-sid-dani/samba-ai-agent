"""Tool to generate all supported schema variations for SambaAI Cloud's Vespa database."""
...
def main() -> None:
    ...
    for model in SUPPORTED_EMBEDDING_MODELS:
        ...
        write_schema(model.index_name + "__sambaai_alt_index", model.dim, template)
        num_indexes += 2
