...
from sambaai.configs.app_configs import ENTERPRISE_EDITION_ENABLED
from sambaai.configs.constants import KV_CUSTOMER_UUID_KEY
from sambaai.configs.constants import KV_INSTANCE_DOMAIN_KEY
...
_SAMBAAI_TELEMETRY_ENDPOINT = "https://telemetry.sambaai.app/anonymous_telemetry"
...
def optional_telemetry(
    ...
    try:
        ...
        # Should never interfere with normal functions of SambaAI
        pass
...
def mt_cloud_telemetry(
    ...
    # This is only for SambaAI MT Cloud, this code should also never be hit, no reason for any orgs to
    # be running the Multi Tenant version of SambaAI.
    fetch_versioned_implementation_with_fallback(
        module="sambaai.utils.telemetry",
