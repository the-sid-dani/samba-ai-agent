...
class SambaAIRequestIDFilter(logging.Filter):
...
class SambaAILoggingAdapter(logging.LoggerAdapter):
    def process(
...
SAMBAAI_DOCKER_ENV_STR = "SAMBAAI_RUNNING_IN_DOCKER"


def is_running_in_container() -> bool:
    return os.getenv(SAMBAAI_DOCKER_ENV_STR) == "true"
...
def setup_uvicorn_logger(
    ...
    uvicorn_logger.addFilter(SambaAIRequestIDFilter())
