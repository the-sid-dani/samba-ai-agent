...
from sambaai.configs.app_configs import EMAIL_FROM
from sambaai.configs.app_configs import SENDGRID_API_KEY
from sambaai.configs.app_configs import SMTP_PASS
from sambaai.configs.app_configs import SMTP_PORT
from sambaai.configs.app_configs import SMTP_SERVER
from sambaai.configs.app_configs import SMTP_USER
...
from sambaai.configs.constants import ONYX_SLACK_URL
...
def send_email_with_sendgrid(
    ...
    from_email = Email(mail_from) if mail_from else Email("noreply@sambaai.app")
...
def send_email_with_smtplib(
    ...
    msg["Message-ID"] = make_msgid(domain="sambaai.app")
...
def send_subscription_cancellation_email(user_email: str) -> None:
    ...
    try:
        load_runtime_settings_fn = fetch_versioned_implementation(
            "sambaai.server.enterprise_settings.store", "load_runtime_settings"
        )
    ...
    cta_link = "https://www.sambaai.app/pricing"
    ...
    text_content = (
        ...
        "If you change your mind, visit https://www.sambaai.app/pricing"
    )
    send_email(
        user_email,
        subject,
