...
ONYX_DEFAULT_APPLICATION_NAME = "SambaAI"
ONYX_SLACK_URL = "https://join.slack.com/t/sambaai-dot-app/shared_invite/zt-2twesxdr6-5iQitKZQpgq~hYIZ~dv3KA"
...
TENANT_ID_COOKIE_NAME = "sambaai_tid"  # tenant id - for workaround cases
ANONYMOUS_USER_COOKIE_NAME = "sambaai_anonymous_user"

NO_AUTH_USER_ID = "__no_auth_user__"
NO_AUTH_USER_EMAIL = "anonymous@sambaai.app"
...
ONYX_METADATA_FILENAME = ".sambaai_metadata.json"

# Messages
DISABLED_GEN_AI_MSG = (
    "Your System Admin has disabled the Generative AI functionalities of SambaAI.\n"
    "Please contact them if you wish to have this enabled.\n"
    "You can still use SambaAI as a search engine."
)
...
# API Keys
SAMBAAI_API_KEY_PREFIX = "API_KEY__"
SAMBAAI_API_KEY_DUMMY_EMAIL_DOMAIN = "sambaaiapikey.ai"
...
KV_SETTINGS_KEY = "sambaai_settings"
KV_CUSTOMER_UUID_KEY = "customer_uuid"
KV_INSTANCE_DOMAIN_KEY = "instance_domain"
KV_ENTERPRISE_SETTINGS_KEY = "sambaai_enterprise_settings"
...
SAMBAAI_REDIS_FUNCTION_LOCK_PREFIX = "da_function_lock:"


class DocumentSource(str, Enum):
    # Special case, document passed in via SambaAI APIs without specifying a source type
...
class MilestoneRecordType(str, Enum):
    ...
    CREATED_ONYX_BOT = "created_sambaai_bot"
...
class SambaAIRedisConstants:
    ACTIVE_FENCES = "active_fences"


class SambaAICeleryPriority(int, Enum):
    HIGHEST = 0
    HIGH = auto()
    MEDIUM = auto()
    LOW = auto()
...
ONYX_CELERY_BEAT_HEARTBEAT_KEY = "sambaai:celery:beat:heartbeat"
