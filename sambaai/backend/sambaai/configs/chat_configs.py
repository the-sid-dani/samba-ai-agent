...
INPUT_PROMPT_YAML = "./sambaai/seeding/input_prompts.yaml"
PROMPTS_YAML = "./sambaai/seeding/prompts.yaml"
PERSONAS_YAML = "./sambaai/seeding/personas.yaml"
USER_FOLDERS_YAML = "./sambaai/seeding/user_folders.yaml"
