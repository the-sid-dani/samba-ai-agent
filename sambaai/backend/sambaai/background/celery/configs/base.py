...
from sambaai.configs.app_configs import CELERY_BROKER_POOL_LIMIT
from sambaai.configs.app_configs import CELERY_RESULT_EXPIRES
from sambaai.configs.app_configs import REDIS_DB_NUMBER_CELERY
from sambaai.configs.app_configs import REDIS_DB_NUMBER_CELERY_RESULT_BACKEND
from sambaai.configs.app_configs import REDIS_HEALTH_CHECK_INTERVAL
...
from sambaai.configs.app_configs import REDIS_SSL_CA_CERTS
from sambaai.configs.app_configs import REDIS_SSL_CERT_REQS
from sambaai.configs.constants import SambaAICeleryPriority
from sambaai.configs.constants import REDIS_SOCKET_KEEPALIVE_OPTIONS
...
broker_transport_options = {
    "priority_steps": list(range(len(SambaAICeleryPriority))),
...
task_default_priority = SambaAICeleryPriority.MEDIUM
task_acks_late = True
