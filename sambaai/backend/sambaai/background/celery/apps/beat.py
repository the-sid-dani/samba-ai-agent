...
from sambaai.configs.constants import POSTGRES_CELERY_BEAT_APP_NAME
...
celery_app.config_from_object("sambaai.background.celery.configs.beat")
...
class DynamicTenantScheduler(PersistentScheduler):
    ...
    def _generate_schedule(
        ...
        if MULTI_TENANT:
            ...
            get_cloud_tasks_to_schedule = fetch_versioned_implementation(
                "sambaai.background.celery.tasks.beat_schedule",
        ...
        get_tasks_to_schedule = fetch_versioned_implementation(
            "sambaai.background.celery.tasks.beat_schedule", "get_tasks_to_schedule"
        )
    ...
    def _try_updating_schedule(self) -> None:
        ...
        try:
            beat_multiplier = SambaAIRuntime.get_beat_multiplier()
        except Exception:
