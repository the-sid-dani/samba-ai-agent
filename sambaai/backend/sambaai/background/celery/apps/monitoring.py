...
from sambaai.configs.constants import POSTGRES_CELERY_WORKER_MONITORING_APP_NAME
...
celery_app.config_from_object("sambaai.background.celery.configs.monitoring")
...
celery_app.autodiscover_tasks(
    [
        "sambaai.background.celery.tasks.monitoring",
    ]
)
