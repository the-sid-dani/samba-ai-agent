...
from sambaai.configs.constants import POSTGRES_CELERY_WORKER_INDEXING_APP_NAME
...
celery_app.config_from_object("sambaai.background.celery.configs.indexing")
