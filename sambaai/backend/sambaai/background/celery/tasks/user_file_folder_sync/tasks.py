...
from sambaai.configs.constants import CELERY_USER_FILE_FOLDER_SYNC_BEAT_LOCK_TIMEOUT
...
from sambaai.db.models import Document
...
@shared_task(
    name=SambaAICeleryTask.CHECK_FOR_USER_FILE_FOLDER_SYNC,
    ignore_result=True,
...
def check_for_user_file_folder_sync(self: Task, *, tenant_id: str) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        SambaAIRedisLocks.CHECK_USER_FILE_FOLDER_SYNC_BEAT_LOCK,
...
@shared_task(
    name=SambaAICeleryTask.UPDATE_USER_FILE_FOLDER_METADATA,
    bind=True,
