...
from sambaai.db.connector_credential_pair import add_deletion_failure_message
...
from sambaai.db.document import (
...
from sambaai.db.document_set import delete_document_set_cc_pair_relationship__no_commit
...
from sambaai.db.index_attempt import delete_index_attempts
from sambaai.db.search_settings import get_all_search_settings
...
from sambaai.redis.redis_connector_delete import RedisConnectorDeletePayload
...
@shared_task(
    name=SambaAICeleryTask.CHECK_FOR_CONNECTOR_DELETION,
    ignore_result=True,
...
def check_for_connector_deletion_task(self: Task, *, tenant_id: str) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        SambaAIRedisLocks.CHECK_CONNECTOR_DELETION_BEAT_LOCK,
    ...
    try:
        ...
        lock_beat.reacquire()
        if not r.exists(SambaAIRedisSignals.BLOCK_VALIDATE_CONNECTOR_DELETION_FENCES):
            ...
            r.set(SambaAIRedisSignals.BLOCK_VALIDATE_CONNECTOR_DELETION_FENCES, 1, ex=300)
