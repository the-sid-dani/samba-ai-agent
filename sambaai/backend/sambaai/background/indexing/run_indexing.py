...
from sambaai.background.indexing.checkpointing_utils import check_checkpoint_size
from sambaai.background.indexing.checkpointing_utils import get_latest_valid_checkpoint
from sambaai.background.indexing.checkpointing_utils import save_checkpoint
from sambaai.background.indexing.memory_tracer import MemoryTracer
from sambaai.configs.app_configs import INDEX_BATCH_SIZE
from sambaai.configs.app_configs import INDEXING_SIZE_WARNING_THRESHOLD
from sambaai.configs.app_configs import INDEXING_TRACER_INTERVAL
from sambaai.configs.app_configs import INTEGRATION_TESTS_MODE
from sambaai.configs.app_configs import LEAVE_CONNECTOR_ACTIVE_ON_INITIALIZATION_FAILURE
from sambaai.configs.app_configs import POLL_CONNECTOR_OFFSET
from sambaai.configs.constants import DocumentSource
from sambaai.configs.constants import MilestoneRecordType
from sambaai.connectors.connector_runner import ConnectorRunner
from sambaai.connectors.exceptions import ConnectorValidationError
from sambaai.connectors.exceptions import UnexpectedValidationError
from sambaai.connectors.factory import instantiate_connector
...
from sambaai.db.connector_credential_pair import get_last_successful_attempt_poll_range_end
from sambaai.db.connector_credential_pair import update_connector_credential_pair
from sambaai.db.constants import CONNECTOR_VALIDATION_ERROR_MESSAGE_PREFIX
...
from sambaai.db.enums import IndexModelStatus
from sambaai.db.index_attempt import create_index_attempt_error
from sambaai.db.index_attempt import get_index_attempt
from sambaai.db.index_attempt import get_index_attempt_errors_for_cc_pair
from sambaai.db.index_attempt import get_recent_completed_attempts_for_cc_pair
from sambaai.db.index_attempt import mark_attempt_canceled
from sambaai.db.index_attempt import mark_attempt_failed
from sambaai.db.index_attempt import mark_attempt_partially_succeeded
from sambaai.db.index_attempt import mark_attempt_succeeded
from sambaai.db.index_attempt import transition_attempt_to_in_progress
from sambaai.db.index_attempt import update_docs_indexed
from sambaai.db.models import IndexAttempt
from sambaai.db.models import IndexAttemptError
from sambaai.document_index.factory import get_default_document_index
from sambaai.httpx.httpx_pool import HttpxPool
from sambaai.indexing.embedder import DefaultIndexingEmbedder
from sambaai.indexing.indexing_heartbeat import IndexingHeartbeatInterface
from sambaai.indexing.indexing_pipeline import build_indexing_pipeline
from sambaai.natural_language_processing.search_nlp_models import (
    InformationContentClassificationModel,
)
from sambaai.utils.logger import setup_logger
from sambaai.utils.logger import TaskAttemptSingleton
from sambaai.utils.middleware import make_randomized_sambaai_request_id
    ...
    try:
        ...
        while checkpoint.has_more:
            ...
            for document_batch, failure, next_checkpoint in connector_runner.run(
                ...
                index_attempt_md.request_id = make_randomized_sambaai_request_id("CIX")
