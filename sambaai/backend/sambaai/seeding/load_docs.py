...
from sambaai.access.models import default_public_access
from sambaai.configs.constants import DEFAULT_BOOST
from sambaai.configs.constants import DocumentSource
from sambaai.configs.constants import KV_DOCUMENTS_SEEDED_KEY
...
from sambaai.db.credentials import PUBLIC_CREDENTIAL_ID
...
from sambaai.db.index_attempt import mock_successful_index_attempt
...
from sambaai.document_index.vespa.shared_utils.utils import wait_for_vespa_with_timeout
from sambaai.indexing.indexing_pipeline import index_doc_batch_prepare
from sambaai.indexing.models import ChunkEmbedding
...
def seed_initial_documents(
    ...
    connector_data = ConnectorBase(
        ...
        connector_specific_config={
            "base_url": "https://docs.sambaai.app/more/use_cases",
