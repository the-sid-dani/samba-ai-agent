...
from sambaai.configs.app_configs import DISABLE_INDEX_UPDATE_ON_SWAP
from sambaai.configs.app_configs import MANAGED_VESPA
from sambaai.configs.app_configs import VESPA_NUM_ATTEMPTS_ON_STARTUP
from sambaai.configs.constants import KV_REINDEX_KEY
from sambaai.configs.constants import KV_SEARCH_SETTINGS
from sambaai.configs.model_configs import FAST_GEN_AI_MODEL_VERSION
from sambaai.configs.model_configs import GEN_AI_API_KEY
from sambaai.configs.model_configs import GEN_AI_MODEL_VERSION
from sambaai.context.search.models import SavedSearchSettings
from sambaai.context.search.retrieval.search_runner import (
    download_nltk_data,
)
from sambaai.db.connector import check_connectors_exist
from sambaai.db.connector import create_initial_default_connector
from sambaai.db.connector_credential_pair import associate_default_cc_pair
from sambaai.db.connector_credential_pair import get_connector_credential_pairs
from sambaai.db.connector_credential_pair import resync_cc_pair
from sambaai.db.credentials import create_initial_public_credential
from sambaai.db.document import check_docs_exist
from sambaai.db.enums import EmbeddingPrecision
from sambaai.db.index_attempt import cancel_indexing_attempts_past_model
from sambaai.db.index_attempt import expire_index_attempts
from sambaai.db.llm import fetch_default_provider
from sambaai.db.llm import update_default_provider
from sambaai.db.llm import upsert_llm_provider
from sambaai.db.persona import delete_old_default_personas
...
from sambaai.db.search_settings import update_current_search_settings
from sambaai.db.search_settings import update_secondary_search_settings
...
from sambaai.document_index.vespa.index import VespaIndex
...
from sambaai.llm.llm_provider_options import OPEN_AI_MODEL_NAMES
...
from sambaai.seeding.load_docs import seed_initial_documents
from sambaai.seeding.load_yamls import load_chat_yamls
from sambaai.server.manage.llm.models import LLMProviderUpsertRequest
from sambaai.server.manage.llm.models import ModelConfigurationUpsertRequest
from sambaai.server.settings.store import load_settings
from sambaai.server.settings.store import store_settings
from sambaai.tools.built_in_tools import auto_add_search_tool_to_personas
from sambaai.tools.built_in_tools import load_builtin_tools
from sambaai.tools.built_in_tools import refresh_built_in_tools_cache
from sambaai.utils.gpu_utils import gpu_status_request
...
def setup_sambaai(
    ...
    """
    Setup SambaAI for a particular tenant. In the Single Tenant case, it will set it up for the default schema
...
def setup_multitenant_sambaai() -> None:
