...
from sambaai.auth.users import current_chat_accessible_user
from sambaai.auth.users import current_curator_or_admin_user
from sambaai.auth.users import current_user
from sambaai.background.celery.versioned_apps.client import app as client_app
from sambaai.configs.app_configs import ENABLED_CONNECTOR_TYPES
from sambaai.configs.app_configs import MOCK_CONNECTOR_FILE_PATH
...
from sambaai.configs.constants import ONYX_METADATA_FILENAME
...
from sambaai.connectors.factory import validate_ccpair_for_user
from sambaai.connectors.google_utils.google_auth import (
    get_google_oauth_creds,
)
from sambaai.connectors.google_utils.google_kv import (
...
from sambaai.connectors.google_utils.google_kv import get_auth_url
from sambaai.connectors.google_utils.google_kv import (
    get_google_app_cred,
)
from sambaai.connectors.google_utils.google_kv import (
...
from sambaai.connectors.google_utils.google_kv import verify_csrf
from sambaai.connectors.google_utils.shared_constants import DB_CREDENTIALS_DICT_TOKEN_KEY
from sambaai.connectors.google_utils.shared_constants import (
    GoogleOAuthAuthenticationMethod,
)
from sambaai.db.connector import create_connector
from sambaai.db.connector import delete_connector
from sambaai.db.connector import fetch_connector_by_id
from sambaai.db.connector import fetch_connectors
from sambaai.db.connector import get_connector_credential_ids
from sambaai.db.connector import mark_ccpair_with_indexing_trigger
from sambaai.db.connector import update_connector
from sambaai.db.connector_credential_pair import add_credential_to_connector
from sambaai.db.connector_credential_pair import get_cc_pair_groups_for_ids
from sambaai.db.connector_credential_pair import get_cc_pair_groups_for_ids_parallel
from sambaai.db.connector_credential_pair import get_connector_credential_pair
from sambaai.db.connector_credential_pair import get_connector_credential_pairs_for_user
from sambaai.db.connector_credential_pair import (
    get_connector_credential_pairs_for_user_parallel,
)
from sambaai.db.credentials import cleanup_gmail_credentials
from sambaai.db.credentials import cleanup_google_drive_credentials
from sambaai.db.credentials import create_credential
from sambaai.db.credentials import delete_service_account_credentials
from sambaai.db.credentials import fetch_credential_by_id_for_user
from sambaai.db.deletion_attempt import check_deletion_attempt_is_allowed
from sambaai.db.document import get_document_counts_for_cc_pairs_parallel
from sambaai.db.engine import get_current_tenant_id
from sambaai.db.engine import get_session
from sambaai.db.enums import AccessType
from sambaai.db.enums import IndexingMode
from sambaai.db.index_attempt import get_index_attempts_for_cc_pair
from sambaai.db.index_attempt import get_latest_index_attempts_by_status
from sambaai.db.index_attempt import get_latest_index_attempts_parallel
from sambaai.db.models import ConnectorCredentialPair
from sambaai.db.models import IndexAttempt
from sambaai.db.models import IndexingStatus
from sambaai.db.models import User
from sambaai.db.models import UserGroup__ConnectorCredentialPair
from sambaai.db.search_settings import get_current_search_settings
from sambaai.db.search_settings import get_secondary_search_settings
from sambaai.file_processing.extract_file_text import convert_docx_to_txt
...
from sambaai.server.documents.models import AuthStatus
from sambaai.server.documents.models import AuthUrl
from sambaai.server.documents.models import ConnectorCredentialPairIdentifier
from sambaai.server.documents.models import ConnectorIndexingStatus
from sambaai.server.documents.models import ConnectorSnapshot
from sambaai.server.documents.models import ConnectorStatus
from sambaai.server.documents.models import ConnectorUpdateRequest
from sambaai.server.documents.models import CredentialBase
from sambaai.server.documents.models import CredentialSnapshot
from sambaai.server.documents.models import FailedConnectorIndexingStatus
from sambaai.server.documents.models import FileUploadResponse
from sambaai.server.documents.models import GDriveCallback
from sambaai.server.documents.models import GmailCallback
from sambaai.server.documents.models import GoogleAppCredentials
from sambaai.server.documents.models import GoogleServiceAccountCredentialRequest
from sambaai.server.documents.models import GoogleServiceAccountKey
from sambaai.server.documents.models import IndexAttemptSnapshot
from sambaai.server.documents.models import ObjectCreationIdResponse
from sambaai.server.documents.models import RunConnectorRequest
from sambaai.server.models import StatusResponse
from sambaai.utils.logger import setup_logger
from sambaai.utils.telemetry import create_milestone_and_report
from sambaai.utils.threadpool_concurrency import run_functions_tuples_in_parallel
...
def create_connector_from_model(
    ...
    try:
        ...
        fetch_ee_implementation_or_noop(
            "sambaai.db.user_group", "validate_object_creation_for_user", None
        )(
            db_session=db_session,
            user=user,
...
def create_connector_with_mock_credential(
    ...
    try:
        ...
        client_app.send_task(
            SambaAICeleryTask.CHECK_FOR_INDEXING,
...
def trigger_indexing_for_cc_pair(
    ...
    priority = SambaAICeleryPriority.HIGHEST if is_user_file else SambaAICeleryPriority.HIGH
