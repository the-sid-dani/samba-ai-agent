...
from sambaai.db.document_set import check_document_sets_are_public
from sambaai.db.document_set import fetch_all_document_sets_for_user
from sambaai.db.document_set import insert_document_set
from sambaai.db.document_set import mark_document_set_as_to_be_deleted
from sambaai.db.document_set import update_document_set
...
from sambaai.server.features.document_set.models import CheckDocSetPublicRequest
from sambaai.server.features.document_set.models import CheckDocSetPublicResponse
from sambaai.server.features.document_set.models import DocumentSet
from sambaai.server.features.document_set.models import DocumentSetCreationRequest
from sambaai.server.features.document_set.models import DocumentSetUpdateRequest
...
def create_document_set(
    ...
    client_app.send_task(
        SambaAICeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
