...
from sambaai.configs.constants import KV_SETTINGS_KEY
...
def load_settings() -> Settings:
    ...
    try:
        ...
        if value is not None:
            ...
            redis_client.set(SambaAIRedisLocks.ANONYMOUS_USER_ENABLED, "0")
    except Exception as e:
...
def store_settings(settings: Settings) -> None:
    ...
    if settings.anonymous_user_enabled is not None:
        redis_client.set(
            SambaAIRedisLocks.ANONYMOUS_USER_ENABLED,
