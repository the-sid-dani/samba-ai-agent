...
from sambaai.context.search.models import SearchSettingsCreationRequest
...
from sambaai.db.search_settings import create_search_settings
from sambaai.db.search_settings import delete_search_settings
from sambaai.db.search_settings import get_current_search_settings
from sambaai.db.search_settings import get_embedding_provider_from_provider_type
...
from sambaai.db.search_settings import update_search_settings_status
from sambaai.document_index.document_index_utils import get_multipass_config
from sambaai.document_index.factory import get_default_document_index
from sambaai.file_processing.unstructured import delete_unstructured_api_key
from sambaai.file_processing.unstructured import get_unstructured_api_key
from sambaai.file_processing.unstructured import update_unstructured_api_key
from sambaai.natural_language_processing.search_nlp_models import clean_model_name
from sambaai.server.manage.embedding.models import SearchSettingsDeleteRequest
from sambaai.server.manage.models import FullModelVersionResponse
from sambaai.server.models import IdReturn
...
def set_new_search_settings(
    ...
    if search_settings_new.index_name is None:
        ...
        index_name = f"sambaai_chunk_{clean_model_name(search_settings_new.model_name)}"
        if (
