...
from sambaai.configs.app_configs import GENERATIVE_MODEL_ACCESS_CHECK_FREQ
from sambaai.configs.constants import DocumentSource
from sambaai.configs.constants import KV_GEN_AI_KEY_CHECK_TIME
from sambaai.configs.constants import SambaAICeleryPriority
from sambaai.configs.constants import SambaAICeleryTask
from sambaai.db.connector_credential_pair import get_connector_credential_pair_for_user
...
from sambaai.db.feedback import fetch_docs_ranked_by_boost_for_user
from sambaai.db.feedback import update_document_boost_for_user
from sambaai.db.feedback import update_document_hidden_for_user
from sambaai.db.index_attempt import cancel_indexing_attempts_for_ccpair
...
from sambaai.server.manage.models import BoostDoc
from sambaai.server.manage.models import BoostUpdateRequest
from sambaai.server.manage.models import HiddenUpdateRequest
...
def create_deletion_attempt_for_connector_id(
    ...
    client_app.send_task(
        SambaAICeleryTask.CHECK_FOR_CONNECTOR_DELETION,
