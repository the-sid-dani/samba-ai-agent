...
from sambaai.configs.app_configs import EGNYTE_CLIENT_ID
from sambaai.configs.app_configs import EGNYTE_CLIENT_SECRET
...
from sambaai.connectors.interfaces import OAuthConnector
...
from sambaai.file_processing.extract_file_text import detect_encoding
...
from sambaai.file_processing.extract_file_text import is_accepted_file_ext
from sambaai.file_processing.extract_file_text import is_text_file_extension
from sambaai.file_processing.extract_file_text import SambaAIExtensionType
from sambaai.file_processing.extract_file_text import read_text_file
from sambaai.utils.logger import setup_logger
from sambaai.utils.retry_wrapper import request_with_retries
...
def _process_egnyte_file(
    ...
    if not is_accepted_file_ext(
        extension, SambaAIExtensionType.Plain | SambaAIExtensionType.Document
    ):
    ...
    if is_text_file_extension(file_name):
        ...
        file_content_raw, file_metadata = read_text_file(
            file_content, encoding=encoding, ignore_sambaai_metadata=False
        )
    else:
