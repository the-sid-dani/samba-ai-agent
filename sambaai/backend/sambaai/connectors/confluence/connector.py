...
from sambaai.configs.app_configs import CONFLUENCE_CONNECTOR_LABELS_TO_SKIP
from sambaai.configs.app_configs import CONFLUENCE_TIMEZONE_OFFSET
from sambaai.configs.app_configs import CONTINUE_ON_CONNECTOR_FAILURE
from sambaai.configs.app_configs import INDEX_BATCH_SIZE
from sambaai.configs.constants import DocumentSource
from sambaai.connectors.confluence.sambaai_confluence import extract_text_from_confluence_html
from sambaai.connectors.confluence.sambaai_confluence import SambaAIConfluence
from sambaai.connectors.confluence.utils import build_confluence_document_id
from sambaai.connectors.confluence.utils import convert_attachment_to_content
from sambaai.connectors.confluence.utils import datetime_from_string
from sambaai.connectors.confluence.utils import process_attachment
from sambaai.connectors.confluence.utils import update_param_in_path
from sambaai.connectors.confluence.utils import validate_attachment_filetype
...
from sambaai.connectors.interfaces import ConnectorCheckpoint
from sambaai.connectors.interfaces import ConnectorFailure
from sambaai.connectors.interfaces import CredentialsConnector
from sambaai.connectors.interfaces import CredentialsProviderInterface
...
from sambaai.connectors.models import BasicExpertInfo
...
class ConfluenceConnector(
    ...
    def __init__(
        ...
        self._confluence_client: SambaAIConfluence | None = None
        self._low_timeout_confluence_client: SambaAIConfluence | None = None
    ...
    @property
    def confluence_client(self) -> SambaAIConfluence:
        if self._confluence_client is None:
            raise ConnectorMissingCredentialError("Confluence")
        return self._confluence_client

    @property
    def low_timeout_confluence_client(self) -> SambaAIConfluence:
    ...
    def set_credentials_provider(
        ...
        confluence_client = SambaAIConfluence(
        ...
        low_timeout_confluence_client = SambaAIConfluence(
            is_cloud=self.is_cloud,
            url=self.wiki_base,
            credentials_provider=credentials_provider,
            timeout=3,
