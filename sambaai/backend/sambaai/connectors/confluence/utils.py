...
from sambaai.configs.app_configs import (
    CONFLUENCE_CONNECTOR_ATTACHMENT_CHAR_COUNT_THRESHOLD,
)
from sambaai.configs.app_configs import CONFLUENCE_CONNECTOR_ATTACHMENT_SIZE_THRESHOLD
...
from sambaai.db.models import PGFileStore
from sambaai.db.pg_file_store import create_populate_lobj
from sambaai.db.pg_file_store import save_bytes_to_pgfilestore
from sambaai.db.pg_file_store import upsert_pgfilestore
from sambaai.file_processing.extract_file_text import (
    SambaAIExtensionType,
    extract_file_text,
...
def _attachment_to_download_link(
    confluence_client: "SambaAIConfluence", attachment: dict[str, Any]
) -> str:
