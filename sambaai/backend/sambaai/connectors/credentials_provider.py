...
class SambaAIDBCredentialsProvider(
    CredentialsProviderInterface["SambaAIDBCredentialsProvider"]
):
    ...
    def __enter__(self) -> "SambaAIDBCredentialsProvider":
...
class SambaAIStaticCredentialsProvider(
    CredentialsProviderInterface["SambaAIStaticCredentialsProvider"]
):
    ...
    def __enter__(self) -> "SambaAIStaticCredentialsProvider":
        return self
