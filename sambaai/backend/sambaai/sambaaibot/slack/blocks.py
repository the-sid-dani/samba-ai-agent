...
from sambaai.configs.sambaaibot_configs import SAMBAAI_BOT_NUM_DOCS_TO_DISPLAY
from sambaai.context.search.models import SavedSearchDoc
from sambaai.db.chat import get_chat_session_by_message_id
from sambaai.db.engine import get_session_with_current_tenant
from sambaai.db.models import ChannelConfig
from sambaai.sambaaibot.slack.constants import CONTINUE_IN_WEB_UI_ACTION_ID
...
from sambaai.sambaaibot.slack.formatting import format_slack_message
from sambaai.sambaaibot.slack.icons import source_to_github_img_link
from sambaai.sambaaibot.slack.models import ActionValuesEphemeralMessage
from sambaai.sambaaibot.slack.models import ActionValuesEphemeralMessageChannelConfig
from sambaai.sambaaibot.slack.models import ActionValuesEphemeralMessageMessageInfo
from sambaai.sambaaibot.slack.models import SlackMessageInfo
from sambaai.sambaaibot.slack.utils import build_continue_in_web_ui_id
from sambaai.sambaaibot.slack.utils import build_feedback_id
from sambaai.sambaaibot.slack.utils import build_publish_ephemeral_message_id
from sambaai.sambaaibot.slack.utils import remove_slack_text_interactions
from sambaai.sambaaibot.slack.utils import translate_vespa_highlight_to_slack
from sambaai.utils.text_processing import decode_escapes
...
def _build_documents_blocks(
    ...
    message_id: int | None,
    num_docs_to_display: int = SAMBAAI_BOT_NUM_DOCS_TO_DISPLAY,
) -> list[Block]:
    header_text = (
...
def _build_answer_blocks(
    answer: ChatSambaAIBotResponse, fallback_answer: str
) -> list[SectionBlock]:
...
def build_slack_response_blocks(
    ...
    """
    # If called with the SambaAIBot slash command, the question is lost so we have to reshow it
