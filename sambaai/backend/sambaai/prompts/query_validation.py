...
from sambaai.prompts.constants import GENERAL_SEP_PAT
from sambaai.prompts.constants import QUESTION_PAT
...
{QUESTION_PAT.upper()} SambaAI is unreachable.
```
{THOUGHT_PAT.upper()} The system searches documents related to SambaAI being unreachable. \
Assuming the documents from search contains situations where SambaAI is not reachable and \
