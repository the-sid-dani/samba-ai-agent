...
from sambaai.agents.agent_search.run_graph import run_agent_search_graph
from sambaai.agents.agent_search.run_graph import run_basic_graph
from sambaai.agents.agent_search.run_graph import run_dc_graph
from sambaai.chat.models import AgentAnswerPiece
from sambaai.chat.models import AnswerPacket
from sambaai.chat.models import AnswerStream
...
from sambaai.configs.agent_configs import AGENT_ALLOW_REFINEMENT
from sambaai.configs.agent_configs import INITIAL_SEARCH_DECOMPOSITION_ENABLED
...
from sambaai.utils.gpu_utils import fast_gpu_status_request
...
class Answer:
    ...
    def llm_answer(self) -> str:
        ...
        for packet in self.processed_streamed_output:
            ...
            if (isinstance(packet, SambaAIAnswerPiece) and packet.answer_piece) or (
    ...
    def llm_answer_by_level(self) -> dict[int, str]:
        ...
        for packet in self.processed_streamed_output:
            ...
            elif isinstance(packet, SambaAIAnswerPiece) and packet.answer_piece:
