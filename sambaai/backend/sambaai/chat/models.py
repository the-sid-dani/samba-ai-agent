...
from sambaai.tools.tool_implementations.custom.base_tool_types import ToolResultType
...
class SambaAIAnswerPiece(BaseModel):
...
class ChatSambaAIBotResponse(BaseModel):
