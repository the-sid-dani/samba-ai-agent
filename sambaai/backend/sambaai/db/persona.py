...
from sambaai.db.models import PersonaLabel
from sambaai.db.models import Prompt
from sambaai.db.models import StarterMessage
from sambaai.db.models import Tool
from sambaai.db.models import User
from sambaai.db.models import User__UserGroup
...
def make_persona_private(
    ...
    if group_ids:
        raise NotImplementedError("SambaAI MIT does not support private Personas")
...
def create_update_persona(
    ...
    try:
        ...
        versioned_make_persona_private = fetch_versioned_implementation(
            "sambaai.db.persona", "make_persona_private"
        )
...
def validate_persona_tools(tools: list[Tool]) -> None:
    for tool in tools:
        if tool.name == "InternetSearchTool" and not BING_API_KEY:
            raise ValueError(
                "Bing API key not found, please contact your SambaAI admin to get it added!"
            )
