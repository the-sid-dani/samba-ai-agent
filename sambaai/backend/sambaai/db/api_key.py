...
from sambaai.auth.api_key import ApiKeyDescriptor
from sambaai.auth.api_key import build_displayable_api_key
from sambaai.auth.api_key import generate_api_key
from sambaai.auth.api_key import hash_api_key
...
from sambaai.db.models import ApiKey
from sambaai.db.models import User
from sambaai.server.api_key.models import APIKeyArgs
from shared_configs.contextvars import get_current_tenant_id


def get_api_key_email_pattern() -> str:
    return SAMBAAI_API_KEY_DUMMY_EMAIL_DOMAIN
...
def get_api_key_fake_email(
    ...
    return f"{SAMBAAI_API_KEY_PREFIX}{name}@{unique_id}{SAMBAAI_API_KEY_DUMMY_EMAIL_DOMAIN}"
