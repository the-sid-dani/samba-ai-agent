...
from sambaai.agents.agent_search.shared_graph_utils.models import CombinedAgentMetrics
from sambaai.agents.agent_search.shared_graph_utils.models import (
    SubQuestionAnswerResults,
)
from sambaai.auth.schemas import UserRole
from sambaai.chat.models import DocumentRelevance
from sambaai.configs.chat_configs import HARD_DELETE_CHATS
...
from sambaai.context.search.models import RetrievalDocs
from sambaai.context.search.models import SavedSearchDoc
from sambaai.context.search.models import SearchDoc as ServerSearchDoc
from sambaai.context.search.utils import chunks_or_sections_to_search_docs
from sambaai.db.models import AgentSearchMetrics
from sambaai.db.models import AgentSubQuery
from sambaai.db.models import AgentSubQuestion
from sambaai.db.models import ChatMessage
from sambaai.db.models import ChatMessage__SearchDoc
from sambaai.db.models import ChatSession
from sambaai.db.models import ChatSessionSharedStatus
from sambaai.db.models import Prompt
from sambaai.db.models import SearchDoc
...
from sambaai.db.persona import get_best_persona_id_for_user
from sambaai.db.pg_file_store import delete_lobj_by_name
from sambaai.file_store.models import FileDescriptor
from sambaai.file_store.models import InMemoryChatFile
from sambaai.llm.override_models import LLMOverride
from sambaai.llm.override_models import PromptOverride
from sambaai.server.query_and_chat.models import ChatMessageDetail
from sambaai.server.query_and_chat.models import SubQueryDetail
from sambaai.server.query_and_chat.models import SubQuestionDetail
...
# Chat sessions do not include sambaaibot flows
def get_chat_sessions_by_user(
    user_id: UUID | None,
    deleted: bool | None,
    db_session: Session,
    include_sambaaibot_flows: bool = False,
    limit: int = 50,
) -> list[ChatSession]:
    stmt = select(ChatSession).where(ChatSession.user_id == user_id)

    if not include_sambaaibot_flows:
        stmt = stmt.where(ChatSession.sambaaibot_flow.is_(False))
...
def create_chat_session(
    ...
    chat_session = ChatSession(
        ...
        sambaaibot_flow=sambaaibot_flow,
...
def delete_all_chat_sessions_for_user(
    ...
    query = db_session.query(ChatSession).filter(
        ChatSession.user_id == user_id, ChatSession.sambaaibot_flow.is_(False)
    )
