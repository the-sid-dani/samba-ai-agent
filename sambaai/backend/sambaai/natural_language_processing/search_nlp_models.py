...
from sambaai.configs.app_configs import INDEXING_EMBEDDING_MODEL_NUM_THREADS
from sambaai.configs.app_configs import LARGE_CHUNK_RATIO
from sambaai.configs.app_configs import SKIP_WARM_UP
from sambaai.configs.model_configs import BATCH_SIZE_ENCODE_CHUNKS
...
from sambaai.natural_language_processing.exceptions import (
...
WARM_UP_STRINGS = [
    ...
    "https://docs.sambaai.app/quickstart",
]
...
class EmbeddingModel:
    ...
    def _make_model_server_request(
        ...
        def _make_request() -> Response:
            headers = {}
            if tenant_id:
                headers["X-SambaAI-Tenant-ID"] = tenant_id

            if request_id:
                headers["X-SambaAI-Request-ID"] = request_id
