...
from sambaai.configs.app_configs import AZURE_DALLE_API_BASE
from sambaai.configs.app_configs import AZURE_DALLE_API_KEY
from sambaai.configs.app_configs import AZURE_DALLE_API_VERSION
from sambaai.configs.app_configs import AZURE_DALLE_DEPLOYMENT_NAME
from sambaai.configs.chat_configs import BING_API_KEY
from sambaai.configs.model_configs import GEN_AI_TEMPERATURE
...
from sambaai.tools.built_in_tools import get_built_in_tool_by_id
from sambaai.tools.models import DynamicSchemaInfo
...
from sambaai.tools.utils import compute_all_tool_tokens
from sambaai.tools.utils import explicit_tool_calling_supported
from sambaai.utils.headers import header_dict_to_header_list
...
class SearchToolConfig(BaseModel):
    ...
    # Use with care, should only be used for SambaAIBot in channels with multiple users
    ...
    for db_tool_model in persona.tools:
        if db_tool_model.in_code_tool_id:
            ...
            # Handle Internet Search Tool
                ...
                if not BING_API_KEY:
                    raise ValueError(
                        "Internet search tool requires a Bing API key, please contact your SambaAI admin to get it added!"
                    )
                tool_dict[db_tool_model.id] = [
                    InternetSearchTool(
