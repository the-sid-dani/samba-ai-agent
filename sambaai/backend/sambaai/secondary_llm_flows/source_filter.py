...
from sambaai.configs.chat_configs import ENABLE_CONNECTOR_CLASSIFIER
from sambaai.configs.constants import DocumentSource
from sambaai.db.connector import fetch_unique_document_sources
...
from sambaai.prompts.constants import SOURCES_KEY
from sambaai.prompts.filter_extration import FILE_SOURCE_WARNING
from sambaai.prompts.filter_extration import SOURCE_FILTER_PROMPT
from sambaai.prompts.filter_extration import WEB_SOURCE_WARNING
...
def extract_source_filter(
    ...
    def _get_source_filter_messages(
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": "What page from SambaAI contains debugging instruction on segfault",
            },
            {
                "role": "assistant",
                "content": json.dumps({SOURCES_KEY: None}),
...
if __name__ == "__main__":
    from sambaai.llm.factory import get_default_llms, get_main_llm_from_tuple
