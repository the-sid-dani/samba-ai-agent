from sambaai.configs.app_configs import VESPA_CLOUD_URL
from sambaai.configs.app_configs import VESPA_CONFIG_SERVER_HOST
from sambaai.configs.app_configs import VESPA_HOST
from sambaai.configs.app_configs import VESPA_PORT
from sambaai.configs.app_configs import VESPA_TENANT_PORT
from sambaai.configs.constants import SOURCE_TYPE
...
# sambaai_chunk below is defined in vespa/app_configs/schemas/sambaai_chunk.sd.jinja
DOCUMENT_ID_ENDPOINT = (
    f"{VESPA_APP_CONTAINER_URL}/document/v1/default/{{index_name}}/docid"
)

# the default document id endpoint is http://localhost:8080/document/v1/default/sambaai_chunk/docid
