...
export interface MinimalSambaAIDocument {
  document_id: string;
  semantic_identifier: string | null;
}

export interface SambaAIDocument extends MinimalSambaAIDocument {
  link: string;
  source_type: ValidSources;
  blurb: string;
  boost: number;
...
export interface LoadedSambaAIDocument extends SambaAIDocument {
  icon: React.FC<{ size?: number; className?: string }>;
}

export interface SearchSambaAIDocument extends SambaAIDocument {
  is_relevant: boolean;
  relevance_explanation: string;
}

export interface FilteredSambaAIDocument extends SambaAIDocument {
  included: boolean;
}
export interface DocumentInfoPacket {
  top_documents: SambaAIDocument[];
...
export interface SearchResponse {
  ...
  answer: string | null;
  quotes: Quote[] | null;
  documents: SearchSambaAIDocument[] | null;
...
export interface SearchRequestArgs {
  ...
  updateDocs: (documents: SambaAIDocument[]) => void;
