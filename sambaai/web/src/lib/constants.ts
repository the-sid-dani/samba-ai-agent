...
export const NEXT_PUBLIC_DO_NOT_USE_TOGGLE_OFF_SAMBAAI_POWERED =
  process.env.NEXT_PUBLIC_DO_NOT_USE_TOGGLE_OFF_SAMBAAI_POWERED?.toLowerCase() ===
  "true";

export const TENANT_ID_COOKIE_NAME = "sambaai_tid";
