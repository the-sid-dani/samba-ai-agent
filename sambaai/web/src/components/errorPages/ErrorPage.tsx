  ...
  return (
    <ErrorPageLayout>
      ...
      <div className="space-y-4 text-gray-600 dark:text-gray-300">
        <p>
          It seems there was a problem loading your SambaAI settings. This could be
        ...
        <p>
          ...
          <a
            ...
            href="https://docs.sambaai.app/introduction?utm_source=app&utm_medium=error_page&utm_campaign=config_error"
            target="_blank"
        ...
        <p>
          ...
          <a
            className="text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300"
            href="https://join.slack.com/t/sambaai/shared_invite/zt-1w76msxmd-HJHLe3KNFIAIzk_0dSOKaQ"
            target="_blank"
            rel="noopener noreferrer"
          >
            Slack community
