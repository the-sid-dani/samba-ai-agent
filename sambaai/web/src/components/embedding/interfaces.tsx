...
export const AVAILABLE_MODELS: HostedEmbeddingModel[] = [
  ...
  },
  {
    ...
    normalize: true,
    description:
      "The smallest and fastest version of the E5 line of models. If you're running SambaAI on a resource constrained system, then this may be a good choice.",
...
export const AVAILABLE_CLOUD_PROVIDERS: CloudEmbeddingProvider[] = [
  {
    ...
    icon: CohereIcon,
    docsLink: "https://docs.sambaai.app/guides/embedding_providers#cohere-models",
    description:
  ...
  },
  {
    ...
    docsLink: "https://docs.sambaai.app/guides/embedding_providers#openai-models",
...

  {
    ...
    icon: GoogleIcon,
    docsLink:
      "https://docs.sambaai.app/guides/embedding_providers#vertex-ai-google-model",
    description:
  ...
  },
  {
    ...
    docsLink: "https://docs.sambaai.app/guides/embedding_providers#voyage-models",
