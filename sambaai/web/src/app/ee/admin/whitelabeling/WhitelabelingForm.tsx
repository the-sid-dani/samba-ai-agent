        ...
        {({ isSubmitting, values, setValues }) => (
          <Form>
            <TextFormField
              ...
              subtext={`The custom name you are giving SambaAI for your team. This will replace 'SambaAI' everywhere in the UI.`}
              placeholder="Custom name which will replace 'SambaAI'"
            ...
            <div>
              ...
              {values.use_custom_logo ? (
                ...
                <SubLabel>
                  Specify your own logo to replace the standard SambaAI logo.
                </SubLabel>
              )}
            ...
            {showAdvancedOptions && (
              <div className="w-full flex flex-col gap-y-4">
                <Text>
                  Read{" "}
                  <Link
                    href={"https://docs.sambaai.app/enterprise_edition/theming"}
                  ...
                  subtext={
                    values.enable_consent_screen
                      ...
                      : `The title for the popup that will be displayed for each user on their initial visit to the application. If left blank AND Custom Popup Content is specified, will use "Welcome to ${
                          values.application_name || "SambaAI"
                        }!".`
                  }
                  placeholder={
                    values.enable_consent_screen
