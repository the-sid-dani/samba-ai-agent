  ...
  return (
    <div className="mb-8">
      ...
      <p className="mb-2 text-sm text-muted-foreground">
        Setup Slack bots that connect to SambaAI. Once setup, you will be able to
        ask questions to SambaAI directly from Slack. Additionally, you can:
      </p>

      <div className="mb-2">
        <ul className="list-disc mt-2 ml-4 text-sm text-muted-foreground">
          <li>
            Setup SambaAIBot to automatically answer questions in certain channels.
          </li>
          <li>
            Choose which document sets SambaAIBot should answer from, depending on
            the channel the question is being asked.
          </li>
          <li>
            Directly message SambaAIBot to search just as you would in the web UI.
          </li>
        </ul>
      </div>
      ...
      <p className="mb-6 text-sm text-muted-foreground">
        ...
        <a
          ...
          href="https://docs.sambaai.app/slack_bot_setup"
          target="_blank"
          rel="noopener noreferrer"
        >
          guide{" "}
        </a>
        found in the SambaAI documentation to get started!
      </p>
