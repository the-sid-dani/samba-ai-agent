  ...
  return (
    <div className="flex flex-col pb-8">
      ...
      <Checkbox
        ...
        sublabel="If set, users will not be required to sign in to use SambaAI."
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <p>
              ...
              anyone to use SambaAI without signing in.
            </p>
      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like SambaAI to retain chat messages. Leaving this field empty will cause SambaAI to never delete chat messages."
