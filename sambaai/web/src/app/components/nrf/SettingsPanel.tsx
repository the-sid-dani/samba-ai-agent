...
export const SettingsPanel = ({
  settingsOpen,
  toggleSettings,
  handleUseSambaAIToggle,
}: {
  settingsOpen: boolean;
  toggleSettings: () => void;
  handleUseSambaAIToggle: (checked: boolean) => void;
}) => {
  const {
    theme,
    setTheme,
  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        <SidebarSwitch
          checked={useSambaAIAsNewTab}
          onCheckedChange={handleUseSambaAIToggle}
          label="Use SambaAI as new tab page"
        />
