...
import { SambaAIInitializingLoader } from "@/components/SambaAIInitializingLoader";
...
export function ChatPage({
  ...
  const [presentingDocument, setPresentingDocument] =
    useState<MinimalSambaAIDocument | null>(null);
  ...
  // 1. default assistant is `SambaAI`
  ...
  const onSubmit = async ({
    ...
    let retrievalType: RetrievalType =
      selectedDocuments.length > 0
        ...
        : RetrievalType.None;
    let documents: SambaAIDocument[] = selectedDocuments;
    let aiMessageImages: FileDescriptor[] | null = null;
    let agenticDocs: SambaAIDocument[] | null = null;
  ...
  const [selectedDocuments, setSelectedDocuments] = useState<SambaAIDocument[]>(
    []
  );
  ...
  const toggleDocumentSelection = (document: SambaAIDocument) => {
