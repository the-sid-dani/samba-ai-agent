...
import { SambaAIDocument, SourceMetadata } from "@/lib/search/interfaces";
...
interface ChatInputBarProps {
  ...
  selectedDocuments: SambaAIDocument[];
  message: string;
        ...
        >
          ...
          >
            ...
            <textarea
              ...
              ref={textAreaRef}
              id="sambaai-chat-input-textarea"
              className={`
                m-0
                w-full
                shrink
            ...
            <div className="flex pr-4 pb-2 justify-between bg-input-background items-center w-full ">
              ...
              <div className="flex items-center my-auto">
                ...
                <button
                  id="sambaai-chat-input-send-button"
