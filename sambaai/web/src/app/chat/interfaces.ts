...
export interface SearchSession {
  ...
  documents: SearchSambaAIDocument[];
...
export interface Message {
  ...
  query?: string | null;
  documents?: SambaAIDocument[] | null;
  ...
  agentic_docs?: SambaAIDocument[] | null;
...
export interface BackendMessage {
  ...
  context_docs: { top_documents: SambaAIDocument[] } | null;
  time_sent: string;
  overridden_model: string;
