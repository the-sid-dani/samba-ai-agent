...
function FileDisplay({
  ...
  alignBubble?: boolean;
  setPresentingDocument: (document: MinimalSambaAIDocument) => void;
}) {
...
export const AIMessage = ({
  ...
  selectedDocuments?: SambaAIDocument[] | null;
  toggleDocumentSelection?: () => void;
  docs?: SambaAIDocument[] | null;
  ...
  files?: FileDescriptor[];
  query?: string;
  citedDocuments?: [string, SambaAIDocument][] | null;
  ...
  let filteredDocs: FilteredSambaAIDocument[] = [];
  ...
  if (docs) {
    filteredDocs = docs
      ...
      .map((doc: SambaAIDocument, ind: number) => {
        return {
          ...doc,
  ...
  return (
    <div
      id={isComplete ? "sambaai-ai-message" : undefined}
