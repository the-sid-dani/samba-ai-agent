...
3. From the dropdown at the top, select "Run All SambaAI Services" and press the green play button
4. CD into web, run "npm i" followed by npm run dev.
5. Now, you can navigate to sambaai in your browser (default is http://localhost:3000) and start using the app
