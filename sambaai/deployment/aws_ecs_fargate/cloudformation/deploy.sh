...
# Unified config file
CONFIG_FILE="sambaai_config.jsonl"
...
INFRA_ORDER=(
  "sambaai_efs_template.yaml"
  "sambaai_cluster_template.yaml"
  "sambaai_acm_template.yaml"
)

# Deployment order for services
SERVICE_ORDER=(
  "sambaai_postgres_service_template.yaml"
  "sambaai_redis_service_template.yaml"
  "sambaai_vespaengine_service_template.yaml"
  "sambaai_model_server_indexing_service_template.yaml"
  "sambaai_model_server_inference_service_template.yaml"
  "sambaai_backend_api_server_service_template.yaml"
  "sambaai_backend_background_server_service_template.yaml"
  "sambaai_web_server_service_template.yaml"
  "sambaai_nginx_service_template.yaml"
)
...
deploy_infra_stacks() {
    for template_name in "${INFRA_ORDER[@]}"; do
      ...
      if [[ "$template_name" == "sambaai_acm_template.yaml" ]]; then
...
echo "Starting deployment of SambaAI to ECS Fargate Cluster..."
deploy_infra_stacks
deploy_services_stacks
