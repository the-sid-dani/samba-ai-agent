...
$COMPOSE_CMD -f docker-compose.prod.yml run  --name sambaai-stack --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.prod.yml -p sambaai-stack up --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.prod.yml -p sambaai-stack up --force-recreate -d
